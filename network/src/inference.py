...
def run_inference(args):
    ...
    model = SwinTransformer_Unet(use_context_mask=args.useContextMask).to(device)
...
def parse_args():
    parser = argparse.ArgumentParser(description="Run 48x48 Swin gridmap inference for one dataset sample.")
